    ...
    <div class="container-fluid m-3">
        ...
        <div class="row d-flex justify-content-center aligh-items-center">
            <div class="col-lg-6 col-xl-3">
                <img src="../images/Registration.jpeg" alt="Admin Registration"
                class="img-fluid">
            </div>
            ...
            <div class="col-lg-6 col-xl-5">
                <form action="" method="post">
                    ...
                    <div>
                        ...
                        <p class="small fw-bold mt-2 pt-1">Don't you already have an acount? <a href="admin_login.php" class="link-danger">Login</a></p>
                    </div>
                </form>
            </div>
        </div>
